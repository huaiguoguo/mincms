...
INSERT INTO `configs` VALUES (1,'open','1'),(2,'close_info',''),(3,'title','application'),(4,'seo','mincms,fuelphp,cms,web,企业建站,b2c'),(5,'stat',''),(6,'footer',''),(7,'seo_author','mincms'),(8,'seo_copyright','mincms'),(9,'admin_title','管理后台'),(10,'url_suffix','.html'),(11,'profiling','2'),(14,'caching','2'),(12,'admin_url_suffix',''),(13,'admin_profiling','2'),(15,'cache_lifetime',''),(16,'cache_dir',''),(17,'email_useragent','ljftaichi.com'),(18,'email_driver','smtp'),(19,'emal_is_html','0'),(20,'email_from','test@admin.com'),(21,'email_from_name','admin'),(22,'email_smtp_host','smtp.163.com'),(23,'email_smtp_port','25'),(24,'email_smtp_username','ljftaichi@163.com'),(25,'email_smtp_password','w4OSUiUw55UNpLl9qvcKhlNZQjE3TGFGd3BVdDd5X01lUGE0MUNVcGRvRjUwd3h6aUstbXl4YUtWclE'),(26,'admin_pagination','10');
...
INSERT INTO `plugin` VALUES (1,'ckeditor','文本编辑器CKeditor','a:2:{s:2:\"js\";a:1:{i:0;s:36:\"plugin/ckeditor/ckeditor/ckeditor.js\";}s:4:\"code\";s:25:\"CKEDITOR.replace(#,{##});\";}','sun kang','http://mincms.com','plugin/ckeditor/ckeditor.php',NULL,1,1),(2,'facybox','facybox弹出层效果','a:3:{s:3:\"css\";a:1:{i:0;s:34:\"plugin/facybox/facybox/facybox.css\";}s:2:\"js\";a:1:{i:0;s:33:\"plugin/facybox/facybox/facybox.js\";}s:4:\"code\";s:19:\"$(#).facybox({##});\";}','sun kang','http://mincms.com','plugin/facybox/facybox.php',NULL,0,1),(3,'code_prettify','google-code-prettify','a:3:{s:3:\"css\";a:1:{i:0;s:55:\"plugin/code_prettify/code-prettify/sons-of-obsidian.css\";}s:2:\"js\";a:1:{i:0;s:46:\"plugin/code_prettify/code-prettify/prettify.js\";}s:4:\"code\";s:15:\"prettyPrint(); \";}',NULL,'http://code.google.com/p/google-code-prettify/','plugin/code_prettify/code_prettify.php',NULL,1,1),(4,'chosen','select选择框效果','a:3:{s:3:\"css\";a:1:{i:0;s:31:\"plugin/chosen/chosen/chosen.css\";}s:2:\"js\";a:1:{i:0;s:41:\"plugin/chosen/chosen/chosen.jquery.min.js\";}s:4:\"code\";s:18:\"$(#).chosen({##});\";}',NULL,'https://github.com/harvesthq/chosen','plugin/chosen/chosen.php',NULL,1,1),(5,'tags_input','jquery tag input效果','a:3:{s:3:\"css\";a:1:{i:0;s:49:\"plugin/tags_input/tags_input/jquery.tagsinput.css\";}s:2:\"js\";a:1:{i:0;s:52:\"plugin/tags_input/tags_input/jquery.tagsinput.min.js\";}s:4:\"code\";s:21:\"$(#).tagsInput({##});\";}',NULL,'https://github.com/harvesthq/chosen','plugin/tags_input/tags_input.php',NULL,0,1);
...
INSERT INTO `plugin_setting` VALUES (1,1,'body','skin:\'v2\',toolbar:\'Full\'','content/node/do'),(2,2,'a[rel*=facybox]','','content/node/index/3'),(8,4,'select','','*'),(7,3,'','','admin/home/index');
...
INSERT INTO `tools` VALUES (1,'database backup','tools/database/backup','sun kang',NULL,'68103403@qq.com',1,1),(2,'sitemap','tools/sitemap/index','sun kang',NULL,'68103403@qq.com',2,0);
...
INSERT INTO `views` VALUES (1,2,5,'admin',NULL),(2,2,3,'admin',NULL);
