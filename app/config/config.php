<?php
if(!is_dir(APPPATH.'../cache')) mkdir(APPPATH.'../cache',777);
/**
...
return array(
	/**
	* user id ,will have all auth . it is array
	*/
	'super_auth'=>array(),
	/**
...
//	'log_date_format'  => 'Y-m-d H:i:s',
	...
	'always_load'  => array(
		...
		'packages'  => array(
			'orm',
			'auth',
			'Casset'=>APPPATH.'packages/casset/', 
			'Pagecache'=>APPPATH.'packages/pagecache/', 
		),
