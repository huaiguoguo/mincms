...
<table  id='t1' class="table table-striped table-bordered table-condensed">
  ...
  <tr>
	...
	<td>
		...
		<?php echo Asset::img('error.png'); if($post['admin_cck_enable'] !=1)$b = true; echo Form::radio('config[admin_cck_enable]', $post['admin_cck_enable']==1?2:$post['admin_cck_enable'],$b);?> <?php echo __('comm.no');?> 
	</td> 
	 
  </tr>
  <tr>
	<td><?php echo __('comm.ffmepg');?></td>
	<td><?php echo Form::input('config[ffmepg]',$post['ffmepg']);?> </td>  
  </tr> 	  
