...
CREATE TABLE IF NOT EXISTS `auto_album` (
...
INSERT INTO `auto_album` (`id`, `sort`, `create_at`, `update_at`, `active`, `title`, `img`, `uid`) VALUES
(1, 1, 1339647181, 1339647181, 1, '默认', '1', 1),
(2, 2, 1339647190, 1339647190, 1, '测试', '2', 1);
...
(24, 'email_smtp_username', 'ljftaichi@163.com'),
(25, 'email_smtp_password', 'w4OSUiUw55UNpLl9qvcKhlNZQjE3TGFGd3BVdDd5X01lUGE0MUNVcGRvRjUwd3h6aUstbXl4YUtWclE'),
...
INSERT INTO `content_fields` (`id`, `type_id`, `sort`, `label`, `name`, `display`, `create_at`, `update_at`, `options`, `form_id`) VALUES
(1, 1, 1, '标题', 'title', 1, 1339644864, 1339644864, NULL, 1),
(2, 1, 2, '内容', 'body', 1, 1339647015, 1339647015, NULL, 5),
(3, 2, 3, '标题', 'title', 1, 1339647044, 1339647044, NULL, 1),
(4, 2, 4, '封面', 'img', 1, 1339647073, 1339647073, NULL, 10),
(5, 2, 5, '用户', 'uid', 1, 1339647100, 1339647100, '"{\\"rt\\":\\"users\\",\\"column\\":\\"username\\"}"', 7),
(8, 3, 8, '图片', 'img', 1, 1339647166, 1339647166, NULL, 10),
(7, 3, 7, '所属相册', 'album', 1, 1339647155, 1339647155, '"{\\"rt\\":\\"auto_album\\",\\"column\\":\\"title\\"}"', 7);
...
INSERT INTO `content_rule` (`id`, `field_id`, `rules`) VALUES
(1, 1, '{"required":"1"}'),
(2, 3, '{"required":"1"}'),
(4, 4, '{"ext_whitelist":"jpg,png,gif","required":"1"}'),
(7, 7, '{"required":"1"}'),
(8, 8, '{"required":"1"}');
...
INSERT INTO `content_type` (`id`, `name`, `val`, `sort`, `display`, `active`) VALUES
(1, '文章', 'post', 1, 1, 1),
(2, '相册', 'album', 2, 1, 1),
(3, '图片', 'img', 3, 1, 1);
...
INSERT INTO `files` (`id`, `name`, `type`, `ext`, `path`, `create_at`, `uid`, `size`) VALUES
(1, 'Hydrangeas.jpg', 'image/jpeg', 'jpg', 'upload/files/af4618925dc5e17c611fa74139b074e2.jpg', 1339647181, 1, 595284),
(2, 'Penguins.jpg', 'image/jpeg', 'jpg', 'upload/files/4cb43b71e729822403b90eacdccf1dfa.jpg', 1339647190, 1, 777835);
...
INSERT INTO `plugin` (`id`, `name`, `discription`, `options`, `auth`, `web`, `path`, `sort`, `active`, `is_js`) VALUES
(1, 'ckeditor', '文本编辑器CKeditor', 'a:2:{s:2:"js";a:1:{i:0;s:36:"plugin/ckeditor/ckeditor/ckeditor.js";}s:4:"code";s:25:"CKEDITOR.replace(#,{##});";}', 'sun kang', 'http://mincms.com', 'plugin/ckeditor/ckeditor.php', NULL, 1, 1),
(2, 'facybox', 'facybox弹出层效果', 'a:3:{s:3:"css";a:1:{i:0;s:34:"plugin/facybox/facybox/facybox.css";}s:2:"js";a:1:{i:0;s:33:"plugin/facybox/facybox/facybox.js";}s:4:"code";s:19:"$(#).facybox({##});";}', 'sun kang', 'http://mincms.com', 'plugin/facybox/facybox.php', NULL, 0, 1),
(3, 'code_prettify', 'google-code-prettify', 'a:3:{s:3:"css";a:1:{i:0;s:55:"plugin/code_prettify/code-prettify/sons-of-obsidian.css";}s:2:"js";a:1:{i:0;s:46:"plugin/code_prettify/code-prettify/prettify.js";}s:4:"code";s:15:"prettyPrint(); ";}', NULL, 'http://code.google.com/p/google-code-prettify/', 'plugin/code_prettify/code_prettify.php', NULL, 1, 1),
(4, 'chosen', 'select选择框效果', 'a:3:{s:3:"css";a:1:{i:0;s:31:"plugin/chosen/chosen/chosen.css";}s:2:"js";a:1:{i:0;s:41:"plugin/chosen/chosen/chosen.jquery.min.js";}s:4:"code";s:18:"$(#).chosen({##});";}', NULL, 'https://github.com/harvesthq/chosen', 'plugin/chosen/chosen.php', NULL, 1, 1),
(5, 'tags_input', 'jquery tag input效果', 'a:3:{s:3:"css";a:1:{i:0;s:49:"plugin/tags_input/tags_input/jquery.tagsinput.css";}s:2:"js";a:1:{i:0;s:52:"plugin/tags_input/tags_input/jquery.tagsinput.min.js";}s:4:"code";s:21:"$(#).tagsInput({##});";}', NULL, 'https://github.com/harvesthq/chosen', 'plugin/tags_input/tags_input.php', NULL, 0, 1);
...
(1, 1, 'body', 'skin:''v2'',toolbar:''Full''', 'content/node/do'),
(2, 2, 'a[rel*=facybox]', '', 'content/node/index/3'),
(8, 4, 'select', '', '*'),
(7, 3, '', '', 'admin/home/index');
...
(34, 12, 'action_index', '缓存列表'),
(35, 12, 'action_del', '删除指定缓存'),
(36, 12, 'action_clear', '清空所有缓存'),
...
(12, 'Admin\\Controller_Cache', 'Admin\\Controller_Cache', NULL),
...
(1, 'admin', 'Lz2ctRARdGg8X8CUtXtW56YbCpKE847lr7GQdAg0AtE=', 1, '68103403@qq.com', '1339747371', 'f3cdc2566994f6b6a56e168c4175df3d5bae36e8', '', 1338794945, 0, 1),
(2, 'test', 'XFe0Bat79p8HyW3FMVYtSFWgkKrgtSfM1Ml/31yBy5g=', 2, 'yiiphp@qq.com', '1338457290', '1401b721642327a996a0730ae409cb5bad5e7e86', NULL, 1338881394, NULL, 1);
...
INSERT INTO `views` (`id`, `type_id`, `field_id`, `type`, `sort`) VALUES
(1, 2, 5, 'admin', NULL),
(2, 2, 3, 'admin', NULL);
